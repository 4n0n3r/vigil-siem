...
const footerLinks = {
  ...
  Docs: [
    ...
    { label: "Detection Rules", href: "/docs/detections" },
  ],
  "Open Source": [
    { label: "GitHub", href: "https://github.com/your-org/vigil" },
    { label: "Contributing", href: "https://github.com/your-org/vigil/blob/main/CONTRIBUTING.md" },
    { label: "License (Apache 2.0)", href: "https://github.com/your-org/vigil/blob/main/LICENSE" },
    { label: "Issues", href: "https://github.com/your-org/vigil/issues" },
  ],
  Legal: [
